            ...
            <MapView 
                ...
                <View className="rounded-t-3xl -mt-12 bg-white relative">
                        <View className="flex-row justify-between px-5 pt-10">
                            ...
                            <Image className="w-24 h-24" source={require('../assets/images/deliveryGuy.gif')} />
                        </View>
                        ...
                        >
                            <View className="p-1 rounded-full" style={{backgroundColor: 'rgba(255,255,255,0.4)'}}>
                                <Image className="h-16 w-16 rounded-full" source={require('../assets/images/deliverGuyPhoto.jpg')} />
                            </View>
